        	...
        	<div class="wrapper">
                <div id="ei-slider" class="ei-slider">
                    <ul class="ei-slider-large">
                        ...
                        <li>
                        	<a href="http://www.pokancomunicacao.com.br/site/veronica-debom/">
                            <img src="<?php bloginfo('template_url'); ?>/images/large/3.jpg" alt="image03" />
                            <div class="ei-title">
                                <h2>Veronica Debom</h2>
                                <h3>Atriz, comediante e escritora</h3>
                                <h4>Na TV, viveu a espevitada patricinha Carla de “Chamas da Vida” e interpretou a professora Cris em “Rebelde” da Rede Record. Fez participações em “Malhação”, “Viver a vida” e nos seriados “Preamar”, da HBO, e “Desenrola Aí”, no Multishow. Já no cinema participou de “Malu de Bicicleta”, “Qualquer gato vira lata” e protagonizou o longa “Astro”.</h4>
                               <h5 class="web">Web</h5>
                            </div>
                            </a>
                        </li>
